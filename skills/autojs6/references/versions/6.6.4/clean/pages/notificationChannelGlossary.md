---
title: "Notification Channel (通知渠道)"
version: "6.6.4"
source_html: "raw/notificationChannelGlossary.html"
---

# Notification Channel (通知渠道) {#notificationchannelglossary_notification_channel}
...
## 创建渠道 {#notificationchannelglossary}

如需创建通知渠道, 可使用 notice.channel.create (notice.html#notice_m_create) 方法.
...
## 渠道重要性 {#notificationchannelglossary_1}
...
## 渠道权限 {#notificationchannelglossary_2}
...
## 删除渠道 {#notificationchannelglossary_3}

可通过 notice.channel.remove (notice.html#notice_m_remove) 删除通知渠道.
