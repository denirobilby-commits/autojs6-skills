...
title: "脚本化 Java"
version: "6.6.4"
source_html: "raw/scriptingJava.html"
---

# 脚本化 Java {#scriptingjava_java}
...
## 访问 Java 包和类 {#scriptingjava_java_1}
...
## 与 Java 协作 {#scriptingjava_java_2}

Rhino 提供了在 JavaScript 代码中 [ 创建 Java 类 / 调用 Java 方法 / 访问变量 ] 等能力.

### Java 类及方法 {#scriptingjava_java_3}
...
### Java 类的静态方法及字段 {#scriptingjava_java_4}
...
### Java 重载方法签名 {#scriptingjava_java_5}
...
### JavaBean 属性 {#scriptingjava_javabean}
...
## 实现 Java 接口 {#scriptingjava_java_6}

### 函数转换 {#scriptingjava_1}
...
## JavaAdapter 构造器 {#scriptingjava_javaadapter}

### 实现 Java 接口 {#scriptingjava_java_7}
...
### 实现多个 Java 接口 {#scriptingjava_java_8}
...
### 继承 Java 类并重写方法 {#scriptingjava_java_9}
