...
title: "密文 (Crypto)"
version: "6.6.4"
source_html: "raw/crypto.html"
---

# 密文 (Crypto) {#crypto_crypto}
...
## [m] digest {#crypto_m_digest}

### digest(message, algorithm) {#crypto_digest_message_algorithm}

**`6.3.2`** **`Overload 1/4`**

- **message** { string (dataTypes.html#datatypes_string) } - 待获取摘要的消息
- **algorithm** { CryptoDigestAlgorithm (dataTypes.html#datatypes_cryptodigestalgorithm) } - 消息摘要算法
- **returns** { string (dataTypes.html#datatypes_string) | JsByteArray (dataTypes.html#datatypes_jsbytearray) }
...
### digest(message) {#crypto_digest_message}
...
### digest(message, algorithm, options) {#crypto_digest_message_algorithm_options}

**`6.3.2`** **`Overload 3/4`**

- **message** { string (dataTypes.html#datatypes_string) } - 待获取摘要的消息
- **algorithm** { CryptoDigestAlgorithm (dataTypes.html#datatypes_cryptodigestalgorithm) } - 消息摘要算法
- **options** { CryptoDigestOptions (dataTypes.html#datatypes_cryptodigestoptions) } - 选项参数
- **returns** { string (dataTypes.html#datatypes_string) | JsByteArray (dataTypes.html#datatypes_jsbytearray) }
...
### digest(message, options) {#crypto_digest_message_options}
...
## [m] encrypt {#crypto_m_encrypt}

### encrypt(data, key, transformation, options?) {#crypto_encrypt_data_key_transformation_options}

**`6.3.2`** **`Overload [1-2]/2`**

- **data** { string (dataTypes.html#datatypes_string) | JsByteArray (dataTypes.html#datatypes_jsbytearray) | ByteArray (dataTypes.html#datatypes_bytearray) } - 待加密数据
- **key** { crypto.Key | java.security.Key (https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/class-use/Key.html) } - 加密密钥
- **transformation** { CryptoCipherTransformation (dataTypes.html#datatypes_cryptociphertransformation) } - 密码转换名称
- **[ options ]** { CryptoCipherOptions (cryptoCipherOptionsType.html) } - 选项参数
- **returns** { string (dataTypes.html#datatypes_string) | JsByteArray (dataTypes.html#datatypes_jsbytearray) }
...
`data` 参数的性质可借助 `options.input` 属性进行区分, 详见 CryptoCipherOptions#input (cryptoCipherOptionsType.html#cryptocipheroptionstype_p_input).

如果 `data` 参数为字节数组, 则 `options.input` 将被忽略. 因为字节数组可以唯一确定 `data` 的性质, 无需再通过 `options.input` 指定.

#### 输出 {#crypto_1}

`options.output` 指定输出的数据格式, 详见 CryptoCipherOptions#output (cryptoCipherOptionsType.html#cryptocipheroptionstype_p_output).
...
加密过程受 `key` 和 `transformation` 两个参数的影响. 详见 crypto.Key 及 CryptoCipherTransformation (dataTypes.html#datatypes_cryptociphertransformation) 小节.
...
## [m] decrypt {#crypto_m_decrypt}

### decrypt(data, key, transformation, options?) {#crypto_decrypt_data_key_transformation_options}

**`6.3.2`** **`Overload [1-2]/2`**

- **data** { string (dataTypes.html#datatypes_string) | JsByteArray (dataTypes.html#datatypes_jsbytearray) | ByteArray (dataTypes.html#datatypes_bytearray) } - 待解密数据
- **key** { crypto.Key | java.security.Key (https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/class-use/Key.html) } - 解密密钥
- **transformation** { CryptoCipherTransformation (dataTypes.html#datatypes_cryptociphertransformation) } - 密码转换名称
- **[ options ]** { CryptoCipherOptions (cryptoCipherOptionsType.html) } - 选项参数
- **returns** { string (dataTypes.html#datatypes_string) | JsByteArray (dataTypes.html#datatypes_jsbytearray) }
...
解密过程受 `key` 和 `transformation` 两个参数的影响. 详见 crypto.Key 及 CryptoCipherTransformation (dataTypes.html#datatypes_cryptociphertransformation) 小节.
...
## [m] generateKeyPair {#crypto_m_generatekeypair}

### generateKeyPair(algorithm, length?) {#crypto_generatekeypair_algorithm_length}

**`6.3.2`** **`Overload [1-2]/2`**

- **algorithm** { CryptoKeyPairGeneratorAlgorithm (dataTypes.html#datatypes_cryptokeypairgeneratoralgorithm) } - 密钥对生成器算法
- **[ length = `256` ]** { number (dataTypes.html#datatypes_number) } - 密钥长度
- **returns** { CryptoKeyPair (cryptoKeyPairType.html) } - 密钥对
...
### [c] (data, options?) {#crypto_c_data_options}

**`6.3.2`** **`Overload [1-2]/2`**

- **data** { string (dataTypes.html#datatypes_string) | JsByteArray (dataTypes.html#datatypes_jsbytearray) | ByteArray (dataTypes.html#datatypes_bytearray) } - 用于生成密钥的数据

- **[ options ]** { CryptoCipherOptions (cryptoCipherOptionsType.html) & {
- keyPair?: `'public'` | `'private'` - 指定密钥的公私性质, 用于非对称加密

- }} - 选项参数
- **returns** { CryptoKey (cryptoKeyType.html) }

生成一个自定义密钥.

关于自定义密钥的实例方法属性及相关示例, 参阅 CryptoKey (cryptoKeyType.html) 类型章节.
...
## [C] KeyPair {#crypto_c_keypair}

### [c] (publicKeyData, privateKeyData, options?) {#crypto_c_publickeydata_privatekeydata_options}

**`6.3.2`** **`Overload [1-2]/2`**

- **publicKeyData** { string (dataTypes.html#datatypes_string) | JsByteArray (dataTypes.html#datatypes_jsbytearray) | ByteArray (dataTypes.html#datatypes_bytearray) } - 用于生成公钥的数据
- **privateKeyData** { string (dataTypes.html#datatypes_string) | JsByteArray (dataTypes.html#datatypes_jsbytearray) | ByteArray (dataTypes.html#datatypes_bytearray) } - 用于生成私钥的数据
- **[ options ]** { CryptoCipherOptions (cryptoCipherOptionsType.html) } - 选项参数
- **returns** { CryptoKeyPair (cryptoKeyPairType.html) }

生成一个固定密钥对.

如需生成一个随机密钥对, 可使用 crypto.generateKeyPair.

关于密钥对的实例方法属性及相关示例, 参阅 CryptoKeyPair (cryptoKeyPairType.html) 类型章节.
