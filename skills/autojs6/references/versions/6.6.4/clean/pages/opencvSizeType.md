...
title: "OpenCVSize"
version: "6.6.4"
source_html: "raw/opencvSizeType.html"
---

# OpenCVSize {#opencvsizetype_opencvsize}
...
- UiObject#size (uiobjectType.html#uiobjecttype_m_size)

注: 本章节仅列出部分属性或方法.

org.opencv.core.Size

## [C] org.opencv.core.Size {#opencvsizetype_c_org_opencv_core_size}

### [c] (width, height) {#opencvsizetype_c_width_height}

- **width** { number (dataTypes.html#datatypes_number) } - 宽度值
- **height** { number (dataTypes.html#datatypes_number) } - 高度值
...
### [c] (point) {#opencvsizetype_c_point}

- **point** { OpenCVPoint (opencvPointType.html) } - 用于表示尺寸的 "点"
- **returns** { org.opencv.core.Size }
...
### [c] (dimensions) {#opencvsizetype_c_dimensions}

- **dimensions** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 尺寸值数组
- **returns** { org.opencv.core.Size }
...
## [p#] width {#opencvsizetype_p_width}

- { number (dataTypes.html#datatypes_number) }

尺寸宽度值.

## [p#] height {#opencvsizetype_p_height}
