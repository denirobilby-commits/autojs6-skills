...
title: "消息通知 (Notice)"
version: "6.6.4"
source_html: "raw/notice.html"
---

# 消息通知 (Notice) {#notice_notice}
...
更多通知渠道的内容, 参阅 通知渠道 (notificationChannelGlossary.html) 术语章节.
...
### notice(content) {#notice_notice_content}

**`6.3.0`** **`Global`** **`Overload 1/8`**

- **content** { string (dataTypes.html#datatypes_string) } - 通知消息的内容
- **returns** { number (dataTypes.html#datatypes_number) } - 通知 ID
...
### notice(title, content) {#notice_notice_title_content}

**`6.3.0`** **`Global`** **`Overload 2/8`**

- **title** { string (dataTypes.html#datatypes_string) } - 通知消息的标题
- **content** { string (dataTypes.html#datatypes_string) } - 通知消息的内容
- **returns** { number (dataTypes.html#datatypes_number) } - 通知 ID
...
### notice(options) {#notice_notice_options}

**`6.3.0`** **`Global`** **`Overload 4/8`**

- **options** { NoticeOptions (noticeOptionsType.html) } - 通知选项配置
- **returns** { number (dataTypes.html#datatypes_number) } - 通知 ID
...
更多配置选项, 可参阅 NoticeOptions (noticeOptionsType.html) 类型章节.

### notice(content, options) {#notice_notice_content_options}
...
### notice(title, content, options) {#notice_notice_title_content_options}
...
### notice(builder) {#notice_notice_builder}

**`6.3.0`** **`Global`** **`Overload 7/8`**

- **builder** { NoticeBuilder (noticeBuilderType.html) } - 通知构建器
- **returns** { number (dataTypes.html#datatypes_number) } - 通知 ID
...
### notice(builder, options) {#notice_notice_builder_options}
...
## [m] isEnabled {#notice_m_isenabled}

### isEnabled() {#notice_isenabled}
...
## [m] ensureEnabled {#notice_m_ensureenabled}

### ensureEnabled() {#notice_ensureenabled}
...
## [m] launchSettings {#notice_m_launchsettings}

### launchSettings() {#notice_launchsettings}
...
## [m] cancel {#notice_m_cancel}

### cancel(id) {#notice_cancel_id}

**`6.3.0`**

- **id** { number (dataTypes.html#datatypes_number) } - 通知 ID
- **returns** { void (dataTypes.html#datatypes_void) }
...
## [m] getBuilder {#notice_m_getbuilder}

### getBuilder() {#notice_getbuilder}
...
构建器可用于设置更多通知行为, 如 setStyle (noticeBuilderType.html#noticebuildertype_m_setstyle), setTimeoutAfter (noticeBuilderType.html#noticebuildertype_m_settimeoutafter), setProgress (noticeBuilderType.html#noticebuildertype_m_setprogress) 等.

但需要注意参数类型需严格符合要求, AutoJs6 内置的 全能类型 (omniTypes.html) 是不可用的.

关于通知构建器的更多用法, 参阅 NoticeBuilder (noticeBuilderType.html) 类型章节.

## [m] config {#notice_m_config}
...
### config(preset) {#notice_config_preset}

**`6.3.0`**

- **preset** { NoticePresetConfiguration (noticePresetConfigurationType.html) } - 通知预设配置对象
- **returns** { void (dataTypes.html#datatypes_void) }
...
更多可用的默认行为配置, 参阅 NoticePresetConfiguration (noticePresetConfigurationType.html) 类型章节.

## [p+] channel {#notice_p_channel}

### [m] create {#notice_m_create}

`channel.create` 可用于 [ 创建 / 修改 / 恢复 ] 某个特定 `渠道 ID (Channel ID)` 的通知渠道.

详见 通知渠道 小节.

#### create(channelId) {#notice_create_channelid}

**`6.3.0`** **`Overload 1/3`**

- **channelId** { string (dataTypes.html#datatypes_string) | number (dataTypes.html#datatypes_number) } - 渠道 ID
- **returns** { string (dataTypes.html#datatypes_string) } - 渠道 ID
...
#### create(channelId, options) {#notice_create_channelid_options}

**`6.3.0`** **`Overload 2/3`**

- **channelId** { string (dataTypes.html#datatypes_string) | number (dataTypes.html#datatypes_number) } - 渠道 ID
- **options** { NoticeChannelOptions (noticeChannelOptionsType.html) } - 渠道创建选项
- **returns** { string (dataTypes.html#datatypes_string) } - 渠道 ID
...
更多渠道配置相关信息, 参阅 NoticeChannelOptions (noticeChannelOptionsType.html) 类型章节.

注: 渠道 ID 可能重复指定.
出现重复指定时, 按以下优先级处理:
options.id > channelId

#### create(options) {#notice_create_options}
...
### [m] contains {#notice_m_contains}

#### contains(channelId) {#notice_contains_channelid}

**`6.3.0`**

- **channelId** { string (dataTypes.html#datatypes_string) | number (dataTypes.html#datatypes_number) } - 渠道 ID
- **returns** { boolean (dataTypes.html#datatypes_boolean) } - 当前渠道 ID 是否已被创建
...
### [m] remove {#notice_m_remove}

#### remove(channelId) {#notice_remove_channelid}

**`6.3.0`**

- **channelId** { string (dataTypes.html#datatypes_string) | number (dataTypes.html#datatypes_number) } - 渠道 ID
- **returns** { boolean (dataTypes.html#datatypes_boolean) } - 删除前, 当前渠道 ID 是否已被创建
...
#### get(channelId) {#notice_get_channelid}

**`6.3.0`**

- **returns** { android.app.NotificationChannel (https://developer.android.com/reference/android/app/NotificationChannel) | null (dataTypes.html#datatypes_null) } - 渠道实例
...
### [m] getAll {#notice_m_getall}

#### getAll() {#notice_getall}

**`6.3.0`**

- **returns** { android.app.NotificationChannel (https://developer.android.com/reference/android/app/NotificationChannel)[] (dataTypes.html#datatypes_array) } - 渠道实例数组
