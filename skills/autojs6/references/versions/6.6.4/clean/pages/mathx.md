...
title: "Mathx (Math 扩展)"
version: "6.6.4"
source_html: "raw/mathx.html"
---

# Mathx (Math 扩展) {#mathx_mathx_math}

Mathx 用于扩展 JavaScript 标准内置对象 Math 的功能 (参阅 内置对象扩展 (glossaries.html#glossaries_内置对象扩展)).
...
### randInt(start, stop) {#mathx_randint_start_stop}

**`6.2.0`** **`xObject`** **`Overload 1/5`**

- **start** { number (dataTypes.html#datatypes_number) } - 范围起点 (含)
- **stop** { number (dataTypes.html#datatypes_number) } - 范围止点 (含)
- **returns** { number (dataTypes.html#datatypes_number) } - 范围内随机整数
...
### randInt(stop) {#mathx_randint_stop}
...
### randInt(range?) {#mathx_randint_range}

**`6.2.0`** **`xObject`** **`Overload [3-4]/5`**

- **[ range = [ MIN_SAFE_INTEGER (https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Number/MIN_SAFE_INTEGER), MAX_SAFE_INTEGER (https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Number/MAX_SAFE_INTEGER) ] ]** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 范围数组 (含两边界)
- **returns** { number (dataTypes.html#datatypes_number) } - 范围内随机整数
...
### randInt(...numbers) {#mathx_randint_numbers}

**`6.2.0`** **`xObject`** **`Overload 5/5`**

- **numbers** { ... (documentation.html#documentation_可变参数)number (dataTypes.html#datatypes_number)[] (documentation.html#documentation_可变参数) } - 范围数组 (含两边界)
- **returns** { number (dataTypes.html#datatypes_number) } - 范围内随机整数
...
### sum(...numbers) {#mathx_sum_numbers}

**`6.2.0`** **`xObject`** **`Overload 1/3`**

- **numbers** { ... (documentation.html#documentation_可变参数)number (dataTypes.html#datatypes_number)[] (documentation.html#documentation_可变参数) } - 待求和数字
...
### sum(numbers, fraction?) {#mathx_sum_numbers_fraction}

**`6.2.0`** **`xObject`** **`Overload [2-3]/3`**

- **numbers** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 待求和数字数组
- **[ fraction = undefined ]** { number (dataTypes.html#datatypes_number) } - 小数点后的数字个数
- **returns** { number (dataTypes.html#datatypes_number) }
...
### avg(...numbers) {#mathx_avg_numbers}

**`6.2.0`** **`xObject`** **`Overload 1/3`**

- **numbers** { ... (documentation.html#documentation_可变参数)number (dataTypes.html#datatypes_number)[] (documentation.html#documentation_可变参数) } - 待求算术平均值的数字
- **returns** { number (dataTypes.html#datatypes_number) }
...
### avg(numbers, fraction?) {#mathx_avg_numbers_fraction}

**`6.2.0`** **`xObject`** **`Overload [2-3]/3`**

- **numbers** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 待求算术平均值数字数组
- **[ fraction = undefined ]** { number (dataTypes.html#datatypes_number) } - 小数点后的数字个数
- **returns** { number (dataTypes.html#datatypes_number) }
...
## [m] median {#mathx_m_median}

中位数.

### median(...numbers) {#mathx_median_numbers}

**`6.2.0`** **`xObject`** **`Overload 1/3`**

- **numbers** { ... (documentation.html#documentation_可变参数)number (dataTypes.html#datatypes_number)[] (documentation.html#documentation_可变参数) } - 待求中位数的数字
- **returns** { number (dataTypes.html#datatypes_number) }
...
### median(numbers, fraction?) {#mathx_median_numbers_fraction}

**`6.2.0`** **`xObject`** **`Overload [2-3]/3`**

- **numbers** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 待求中位数数字数组
- **[ fraction = undefined ]** { number (dataTypes.html#datatypes_number) } - 小数点后的数字个数
- **returns** { number (dataTypes.html#datatypes_number) }
...
### var(...numbers) {#mathx_var_numbers}

**`6.2.0`** **`xObject`** **`Overload 1/3`**

- **numbers** { ... (documentation.html#documentation_可变参数)number (dataTypes.html#datatypes_number)[] (documentation.html#documentation_可变参数) } - 待求方差的数字
- **returns** { number (dataTypes.html#datatypes_number) }
...
### var(numbers, fraction?) {#mathx_var_numbers_fraction}

**`6.2.0`** **`xObject`** **`Overload [2-3]/3`**

- **numbers** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 待求方差数字数组
- **[ fraction = undefined ]** { number (dataTypes.html#datatypes_number) } - 小数点后的数字个数
- **returns** { number (dataTypes.html#datatypes_number) }
...
### std(...numbers) {#mathx_std_numbers}

**`6.2.0`** **`xObject`** **`Overload 1/3`**

- **numbers** { ... (documentation.html#documentation_可变参数)number (dataTypes.html#datatypes_number)[] (documentation.html#documentation_可变参数) } - 待求标准差的数字
- **returns** { number (dataTypes.html#datatypes_number) }
...
### std(numbers, fraction?) {#mathx_std_numbers_fraction}

**`6.2.0`** **`xObject`** **`Overload [2-3]/3`**

- **numbers** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 待求标准差数字数组
- **[ fraction = undefined ]** { number (dataTypes.html#datatypes_number) } - 小数点后的数字个数
- **returns** { number (dataTypes.html#datatypes_number) }
...
### cv(...numbers) {#mathx_cv_numbers}

**`6.2.0`** **`xObject`** **`Overload 1/3`**

- **numbers** { ... (documentation.html#documentation_可变参数)number (dataTypes.html#datatypes_number)[] (documentation.html#documentation_可变参数) } - 待求变异系数的数字
- **returns** { number (dataTypes.html#datatypes_number) }
...
### cv(numbers, fraction?) {#mathx_cv_numbers_fraction}

**`6.2.0`** **`xObject`** **`Overload [2-3]/3`**

- **numbers** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 待求变异系数数字数组
- **[ fraction = undefined ]** { number (dataTypes.html#datatypes_number) } - 小数点后的数字个数
- **returns** { number (dataTypes.html#datatypes_number) }
...
### max(...numbers) {#mathx_max_numbers}

**`6.2.0`** **`xObject`** **`xAlias`** **`Overload 1/3`**

- **numbers** { ... (documentation.html#documentation_可变参数)number (dataTypes.html#datatypes_number)[] (documentation.html#documentation_可变参数) } - 待求最大值的数字
- **returns** { number (dataTypes.html#datatypes_number) }
...
### max(numbers, fraction?) {#mathx_max_numbers_fraction}

**`6.2.0`** **`xObject`** **`xAlias`** **`Overload [2-3]/3`**

- **numbers** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 待求最大值的数字数组
- **[ fraction = undefined ]** { number (dataTypes.html#datatypes_number) } - 小数点后的数字个数
- **returns** { number (dataTypes.html#datatypes_number) }
...
### min(...numbers) {#mathx_min_numbers}

**`6.2.0`** **`xObject`** **`xAlias`** **`Overload 1/3`**

- **numbers** { ... (documentation.html#documentation_可变参数)number (dataTypes.html#datatypes_number)[] (documentation.html#documentation_可变参数) } - 待求最小值的数字
- **returns** { number (dataTypes.html#datatypes_number) }
...
### min(numbers, fraction?) {#mathx_min_numbers_fraction}

**`6.2.0`** **`xObject`** **`xAlias`** **`Overload [2-3]/3`**

- **numbers** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 待求最小值的数字数组
- **[ fraction = undefined ]** { number (dataTypes.html#datatypes_number) } - 小数点后的数字个数
- **returns** { number (dataTypes.html#datatypes_number) }
...
### dist(pointA, pointB, fraction?) {#mathx_dist_pointa_pointb_fraction}

**`6.2.0`** **`xObject`** **`Overload [1-2]/4`**

- **pointA** { [ (dataTypes.html#datatypes_tuple) number (dataTypes.html#datatypes_number), number (dataTypes.html#datatypes_number) ] (dataTypes.html#datatypes_tuple) | { (dataTypes.html#datatypes_object) x: number (dataTypes.html#datatypes_number), y: number (dataTypes.html#datatypes_number) } (dataTypes.html#datatypes_object) | OpenCVPoint (opencvPointType.html) | AndroidRect (androidRectType.html) }
- **pointB** { [ (dataTypes.html#datatypes_tuple) number (dataTypes.html#datatypes_number), number (dataTypes.html#datatypes_number) ] (dataTypes.html#datatypes_tuple) | { (dataTypes.html#datatypes_object) x: number (dataTypes.html#datatypes_number), y: number (dataTypes.html#datatypes_number) } (dataTypes.html#datatypes_object) | OpenCVPoint (opencvPointType.html) | AndroidRect (androidRectType.html) }
- **[ fraction = undefined ]** { number (dataTypes.html#datatypes_number) } - 小数点后的数字个数
- **returns** { number (dataTypes.html#datatypes_number) }
...
### dist(rect, fraction?) {#mathx_dist_rect_fraction}

**`6.2.0`** **`xObject`** **`Overload [3-4]/4`**

- **rect** { AndroidRect (androidRectType.html) } - 矩形
- **[ fraction = undefined ]** { number (dataTypes.html#datatypes_number) } - 小数点后的数字个数
- **returns** { number (dataTypes.html#datatypes_number) }
