---
title: "文档更新日志 (Changelog)"
version: "6.6.4"
source_html: "raw/changelog.html"
---

# 文档更新日志 (Changelog) {#changelog_changelog}

## v1.1.8 {#changelog_v1_1_8}
...
- `修复` floaty 模块 widht 拼写失误 *`issue #1` (http://docs-project.autojs6.com/issues/1)*
- `优化` 完善 Base64 (https://docs.autojs6.com/#/base64) 章节
- `优化` 完善 颜色 (Color) (https://docs.autojs6.com/#/color) 章节

## v1.1.4 {#changelog_v1_1_4}
