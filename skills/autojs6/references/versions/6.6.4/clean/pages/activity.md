...
title: "活动 (Activity)"
version: "6.6.4"
source_html: "raw/activity.html"
---

# 活动 (Activity) {#activity_activity}
...
activity 是一个 `ScriptExecuteActivity` 实例, 同时也是一个 `Activity` 实例, 详见 数据类型 (dataTypes.html#datatypes_scriptexecuteactivity) 章节.
