---
title: "CryptoCipherOptions"
version: "6.6.4"
source_html: "raw/cryptoCipherOptionsType.html"
---

# CryptoCipherOptions {#cryptocipheroptionstype_cryptocipheroptions}

CryptoCipherOptions 是一个用于 `密码 (Cipher)` 加解密的选项接口, 主要用于 密文 (crypto.html) 模块.
...
## [p?] input {#cryptocipheroptionstype_p_input}
...
## [p?] output {#cryptocipheroptionstype_p_output}
...
## [p?] encoding {#cryptocipheroptionstype_p_encoding}
...
## [p?] dest {#cryptocipheroptionstype_p_dest}

- { string (dataTypes.html#datatypes_string) } - 目标路径
...
## [p?] iv {#cryptocipheroptionstype_p_iv}

- { string (dataTypes.html#datatypes_string) | JsByteArray (dataTypes.html#datatypes_jsbytearray) | ByteArray (dataTypes.html#datatypes_bytearray) | java.security.spec.AlgorithmParameterSpec (https://developer.android.com/reference/java/security/spec/AlgorithmParameterSpec) } - 初始向量
