...
version: "6.6.4"
source_html: "raw/s13n.html"
---

# 标准化 (Standardization) {#s13n_standardization}
...
例如在 AutoJs6 中, 一个颜色参数通常可接受 [ ColorHex (dataTypes.html#datatypes_colorhex) / ColorInt (dataTypes.html#datatypes_colorint) / ColorName (dataTypes.html#datatypes_colorname) / Color (colorType.html) / ThemeColor (dataTypes.html#datatypes_themecolor) ] 等多种类型:
...
方法名称 描述 接受类型 输出类型 color 颜色 OmniColor (omniTypes.html#omnitypes_omnicolor) ColorInt (dataTypes.html#datatypes_colorint)

s13n

## [m] color {#s13n_m_color}

### color(o) {#s13n_color_o}

- **o** { OmniColor (omniTypes.html#omnitypes_omnicolor) }
- **returns** { ColorInt (dataTypes.html#datatypes_colorint) }

将颜色参数 `o` 标准化为 ColorInt (dataTypes.html#datatypes_colorint).
...
## [m] throwable {#s13n_m_throwable}

### throwable(o) {#s13n_throwable_o}

- **o** { OmniThrowable (omniTypes.html#omnitypes_omnithrowable) }
- **returns** { java.lang.Throwable (exceptions.html#exceptions_java) }

将可抛异常参数 `o` 标准化为 java.lang.Throwable (exceptions.html#exceptions_java) 类型.
