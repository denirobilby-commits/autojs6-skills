...
title: "OpenCVRect"
version: "6.6.4"
source_html: "raw/opencvRectType.html"
---

# OpenCVRect {#opencvrecttype_opencvrect}

org.opencv.core.Rect (https://docs.opencv.org/3.4/javadoc/org/opencv/core/Rect.html) 别名.

与 AndroidRect (androidRectType.html) 类似, OpenCVRect 也可表示一个矩形, 通常用于图像的区域表示.
...
## [C] org.opencv.core.Rect {#opencvrecttype_c_org_opencv_core_rect}
...
## [p#] width {#opencvrecttype_p_width}
...
## [p#] height {#opencvrecttype_p_height}
