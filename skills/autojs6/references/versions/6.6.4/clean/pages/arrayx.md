---
title: "Arrayx (Array 扩展)"
version: "6.6.4"
source_html: "raw/arrayx.html"
---

# Arrayx (Array 扩展) {#arrayx_arrayx_array}

Arrayx 用于扩展 JavaScript 标准内置对象 Array 的功能 (参阅 内置对象扩展 (glossaries.html#glossaries_内置对象扩展)).
...
## [m] ensureArray {#arrayx_m_ensurearray}

### ensureArray(...o) {#arrayx_ensurearray_o}
...
## [m] intersect {#arrayx_m_intersect}

### intersect(o, ...others) {#arrayx_intersect_o_others}

**`6.2.0`** **`xProto`**

- **o** { T (dataTypes.html#datatypes_generic)[] (dataTypes.html#datatypes_array) } - 数组
- **others** { ... (documentation.html#documentation_可变参数)U (dataTypes.html#datatypes_generic)[] (dataTypes.html#datatypes_array)[] (documentation.html#documentation_可变参数) } - 待处理数组
- **returns** { (T (dataTypes.html#datatypes_generic) & U (dataTypes.html#datatypes_generic))[] (dataTypes.html#datatypes_array) }
...
## [m] union {#arrayx_m_union}

### union(o, ...others) {#arrayx_union_o_others}
...
## [m] distinct {#arrayx_m_distinct}

### distinct(arr) {#arrayx_distinct_arr}

**`6.2.0`** **`xProto`**

- **o** { T (dataTypes.html#datatypes_generic)[] (dataTypes.html#datatypes_array) } - 待处理数组
- **returns** { T (dataTypes.html#datatypes_generic)[] (dataTypes.html#datatypes_array) }
...
## [m] distinctBy {#arrayx_m_distinctby}

### distinctBy(arr, selector) {#arrayx_distinctby_arr_selector}

**`6.2.0`** **`xProto`**

- **arr** { T (dataTypes.html#datatypes_generic)[] (dataTypes.html#datatypes_array) } - 待处理数组
- **selector** { ( (dataTypes.html#datatypes_function)e: T (dataTypes.html#datatypes_generic)) (dataTypes.html#datatypes_function) => (dataTypes.html#datatypes_function) U (dataTypes.html#datatypes_generic) } - 条件选择器
- **returns** { T (dataTypes.html#datatypes_generic)[] (dataTypes.html#datatypes_array) }
...
## [m] sortBy {#arrayx_m_sortby}

### sortBy(arr, selector) {#arrayx_sortby_arr_selector}
...
## [m] sortDescending {#arrayx_m_sortdescending}

### sortDescending(arr) {#arrayx_sortdescending_arr}
...
## [m] sortByDescending {#arrayx_m_sortbydescending}

### sortByDescending(arr, selector) {#arrayx_sortbydescending_arr_selector}
...
## [m] sorted {#arrayx_m_sorted}

### sorted(arr) {#arrayx_sorted_arr}
...
## [m] sortedBy {#arrayx_m_sortedby}

### sortedBy(arr, selector) {#arrayx_sortedby_arr_selector}
...
## [m] sortedDescending {#arrayx_m_sorteddescending}

### sortedDescending(arr) {#arrayx_sorteddescending_arr}
...
## [m] sortedByDescending {#arrayx_m_sortedbydescending}

### sortedByDescending(arr, selector) {#arrayx_sortedbydescending_arr_selector}
...
## [m] shuffle {#arrayx_m_shuffle}

### shuffle(arr) {#arrayx_shuffle_arr}
