---
title: "Numberx (Number 扩展)"
version: "6.6.4"
source_html: "raw/numberx.html"
---

# Numberx (Number 扩展) {#numberx_numberx_number}

Numberx 用于扩展 JavaScript 标准内置对象 Number 的功能 (参阅 内置对象扩展 (glossaries.html#glossaries_内置对象扩展)).
...
- [ `996` ] { number (dataTypes.html#datatypes_number) }
...
## [m] ensureNumber {#numberx_m_ensurenumber}

### ensureNumber(...o) {#numberx_ensurenumber_o}

**`6.2.0`** **`xObject`**

- **o** { ... (documentation.html#documentation_可变参数)any (dataTypes.html#datatypes_any)[] (documentation.html#documentation_可变参数) } - 任意对象
...
## [m] check {#numberx_m_check}

### check(o) {#numberx_check_o}
...
### check(numA, numB) {#numberx_check_numa_numb}

**`6.2.0`** **`Overload 2/3`** **`xObject`**

- **numA** { number (dataTypes.html#datatypes_number) }
- **numB** { number (dataTypes.html#datatypes_number) }
- **returns** { boolean (dataTypes.html#datatypes_boolean) }
...
### check(...numberOrOperator) {#numberx_check_numberoroperator}

**`6.2.0`** **`Overload 3/3`** **`xObject`**

- **o** { ... (documentation.html#documentation_可变参数)(number (dataTypes.html#datatypes_number) | (dataTypes.html#datatypes_联合类型) ComparisonOperatorString (dataTypes.html#datatypes_comparisonoperatorstring))[] (documentation.html#documentation_可变参数) } - 任意对象
- **returns** { boolean (dataTypes.html#datatypes_boolean) }
...
## [m] clamp {#numberx_m_clamp}

### clamp(num, ...clamps) {#numberx_clamp_num_clamps}

**`6.2.0`** **`xProto`**

- **num** { number (dataTypes.html#datatypes_number) } - 待处理数字
- **clamps** { ... (documentation.html#documentation_可变参数)(number (dataTypes.html#datatypes_number) | number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array))[] (documentation.html#documentation_可变参数) } - 限制范围
...
因范围参数 clamps 是 可变参数 (documentation.html#documentation_可变参数), 因此以下两种调用方式效果相同:
...
## [m] clampTo {#numberx_m_clampto}

### clampTo(num, range, cycle?) {#numberx_clampto_num_range_cycle}

**`6.2.0`** **`xProto`** **`Overload [1-2]/2`**

- **num** { number (dataTypes.html#datatypes_number) } - 待处理数字
- **range** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) } - 限制范围
- **[ cycle = `maxOf(range) - minOf(range)` ]** { number (dataTypes.html#datatypes_number) } - 周期, 默认为 range 参数的跨度
- **returns** { number (dataTypes.html#datatypes_number) }
...
## [m] toFixedNum {#numberx_m_tofixednum}

### toFixedNum(num, fraction?) {#numberx_tofixednum_num_fraction}

**`6.2.0`** **`xProto`**

- **num** { number (dataTypes.html#datatypes_number) } - 待处理数字
- **[ fraction = 0 ]** { number (dataTypes.html#datatypes_number) } - 小数点后数字的个数
- **returns** { number (dataTypes.html#datatypes_number) }
...
## [m] padStart {#numberx_m_padstart}

### padStart(num, targetLength, pad?) {#numberx_padstart_num_targetlength_pad}

**`6.2.0`** **`xProto`**

- **num** { number (dataTypes.html#datatypes_number) } - 待处理数字
- **targetLength** { number (dataTypes.html#datatypes_number) } - 当前数字需要填充到的目标字符串长度. 如果此长度小于 num 参数的字符串长度, 则返回 num 参数的字符串本身.
- **[ pad = '0' ]** { string (dataTypes.html#datatypes_string) | number (dataTypes.html#datatypes_number) } - 填充字符串. 如果字符串太长, 使填充后的字符串长度超过了目标长度, 则只保留最左侧部分, 其他部分会被截断. 此参数的默认值为 "0" (U+0030).
...
## [m] padEnd {#numberx_m_padend}

### padEnd(num, targetLength, pad?) {#numberx_padend_num_targetlength_pad}
...
## [m] parseFloat {#numberx_m_parsefloat}

### parseFloat(string, radix) {#numberx_parsefloat_string_radix}

**`6.2.0`** **`xObject`**

- **string** { string (dataTypes.html#datatypes_string) } - 待解析的字符串
- **radix** { number (dataTypes.html#datatypes_number) } - 进制的基数
- **returns** { number (dataTypes.html#datatypes_number) }
...
## [m] parsePercent {#numberx_m_parsepercent}

### parsePercent(percentage) {#numberx_parsepercent_percentage}

**`6.2.0`** **`xObject`**

- **percentage** { string (dataTypes.html#datatypes_string) | number (dataTypes.html#datatypes_number) } - 百分数字符串或任意数字
- **returns** { number (dataTypes.html#datatypes_number) }
...
## [m] parseRatio {#numberx_m_parseratio}

### parseRatio(ratio) {#numberx_parseratio_ratio}

**`6.2.0`** **`xObject`**

- **ratio** { string (dataTypes.html#datatypes_string) } - 比率字符串
- **returns** { number (dataTypes.html#datatypes_number) }
...
## [m] parseAny {#numberx_m_parseany}

### parseAny(o) {#numberx_parseany_o}

**`6.2.0`** **`xObject`**

- **o** { any (dataTypes.html#datatypes_any) } - 待解析的对象
- **returns** { number (dataTypes.html#datatypes_number) }
