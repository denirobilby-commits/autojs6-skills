...
title: "版本工具类 (Version)"
version: "6.6.4"
source_html: "raw/versionType.html"
---

# 版本工具类 (Version) {#versiontype_version}
...
## [C] Version {#versiontype_c_version}

### [c] (versionString) {#versiontype_c_versionstring}

**`6.2.0`** **`Global`** **`Overload 1/2`**

- **versionString** { string (dataTypes.html#datatypes_string) | number (dataTypes.html#datatypes_number) } - 版本号参数
- **returns** { Version }
...
优先级 后缀 5 空或未知 4 rc 3 beta 2 alpha 1 pre + alpha 0 snapshot

```js
console.log(new Version('5.2.3-beta').isHigherThan('5.2.3-snapshot')); // true
```

### [c] (versionString, throwExceptions) {#versiontype_c_versionstring_throwexceptions}

**`6.2.0`** **`Global`** **`Overload 2/2`**

- **versionString** { string (dataTypes.html#datatypes_string) | number (dataTypes.html#datatypes_number) } - 版本号参数
- **[ throwExceptions = `false` ]** { boolean (dataTypes.html#datatypes_boolean) } - 是否在版本号参数不合法时抛出异常
- **returns** { Version }
...
- versionString 参数为 null
- versionString 参数为非数字开头的字符串
...
## [m#] getMajor {#versiontype_m_getmajor}

### getMajor() {#versiontype_getmajor}
...
## [m#] getMinor {#versiontype_m_getminor}

### getMinor() {#versiontype_getminor}
...
## [m#] getPatch {#versiontype_m_getpatch}

### getPatch() {#versiontype_getpatch}
...
## [m#] getSuffix {#versiontype_m_getsuffix}

### getSuffix() {#versiontype_getsuffix}
...
## [m#] isEqual {#versiontype_m_isequal}

### isEqual(otherVersion) {#versiontype_isequal_otherversion}

**`6.2.0`**

- **otherVersion** { string (dataTypes.html#datatypes_string) | Version } - 待比较版本参数
...
## [m#] isHigherThan {#versiontype_m_ishigherthan}

### isHigherThan(otherVersion) {#versiontype_ishigherthan_otherversion}
...
## [m#] isLowerThan {#versiontype_m_islowerthan}

### isLowerThan(otherVersion) {#versiontype_islowerthan_otherversion}
...
## [m#] isAtLeast {#versiontype_m_isatleast}

### isAtLeast(otherVersion) {#versiontype_isatleast_otherversion}
...
### isAtLeast(otherVersion, ignoreSuffix) {#versiontype_isatleast_otherversion_ignoresuffix}
...
## [m#] getSubversionNumbers {#versiontype_m_getsubversionnumbers}

### getSubversionNumbers() {#versiontype_getsubversionnumbers}

**`6.2.0`**

- **returns** { number (dataTypes.html#datatypes_number)[] (dataTypes.html#datatypes_array) }
...
## [m#] getOriginalString {#versiontype_m_getoriginalstring}

### getOriginalString() {#versiontype_getoriginalstring}
...
## [m#] compareTo {#versiontype_m_compareto}

### compareTo(otherVersion) {#versiontype_compareto_otherversion}

**`6.2.0`**

- **otherVersion** { Version } - 待比较版本参数
