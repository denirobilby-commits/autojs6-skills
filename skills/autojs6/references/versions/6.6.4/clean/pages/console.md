...
title: "控制台 (Console)"
version: "6.6.4"
source_html: "raw/console.html"
---

# 控制台 (Console) {#console_console}
...
## [m] show {#console_m_show}

### show() {#console_show}

**`[6.3.0]`**

- **returns** { this (console.html) }
...
## [m] isShowing {#console_m_isshowing}

### isShowing() {#console_isshowing}
...
## [m] collapse {#console_m_collapse}

### collapse() {#console_collapse}
...
## [m] launch {#console_m_launch}

### launch() {#console_launch}
...
## [m] build {#console_m_build}

### build(options) {#console_build_options}

**`6.3.0`**

- **options** { ConsoleBuildOptions (consoleBuildOptionsType.html) } - 构建器选项
- **returns** { { show(): void (dataTypes.html#datatypes_void) }}
...
更多构建参数及使用方法, 参阅 ConsoleBuildOptions (consoleBuildOptionsType.html) 类型章节.

## [m] setSize {#console_m_setsize}

### setSize(width, height) {#console_setsize_width_height}

**`[6.3.0]`**

- **width** { number (dataTypes.html#datatypes_number) } - 浮动窗口宽度值 (像素值/百分数)
- **height** { number (dataTypes.html#datatypes_number) } - 浮动窗口高度值 (像素值/百分数)
- **returns** { this (console.html) }
...
## [m] setPosition {#console_m_setposition}

### setPosition(x, y) {#console_setposition_x_y}

**`[6.3.0]`**

- **x** { number (dataTypes.html#datatypes_number) } - 浮动窗口位置 X 坐标 (像素值/百分数)
- **y** { number (dataTypes.html#datatypes_number) } - 浮动窗口位置 Y 坐标 (像素值/百分数)
- **returns** { this (console.html) }
...
## [m] setExitOnClose {#console_m_setexitonclose}

### setExitOnClose(exitOnClose?) {#console_setexitonclose_exitonclose}

**`6.3.0`** **`Overload 1/2`**

- [ `true` ] **exitOnClose** { boolean (dataTypes.html#datatypes_boolean) } - 浮动窗口是否自动关闭
- **returns** { this (console.html) }
...
### setExitOnClose(timeout) {#console_setexitonclose_timeout}

**`6.3.0`** **`Overload 2/2`**

- **timeout** { number (dataTypes.html#datatypes_number) } - 浮动窗口自动关闭的超时时间 (毫秒)
- **returns** { this (console.html) }
...
## [m] setTouchable {#console_m_settouchable}

### setTouchable(touchable?) {#console_settouchable_touchable}

**`6.5.0`**

- [ `true` ] **touchable** { boolean (dataTypes.html#datatypes_boolean) } - 是否响应点击事件
- **returns** { this (console.html) }
...
当 `setTouchable` 传入 `false` 时, 浮动窗口顶部的关闭按钮将无法通过点击触发, 此时可借助 hide 或 setExitOnClose 等代码方式实现浮动窗口关闭:
...
## [m] setTitle {#console_m_settitle}

### setTitle(title) {#console_settitle_title}

**`[6.3.0]`**

- **title** { string (dataTypes.html#datatypes_string) } - 浮动窗口标题文本
- **returns** { this (console.html) }
...
## [m] setTitleTextSize {#console_m_settitletextsize}

### setTitleTextSize(size) {#console_settitletextsize_size}

**`6.3.0`**

- **size** { number (dataTypes.html#datatypes_number) } - 浮动窗口标题文本字体大小
- **returns** { this (console.html) }
...
## [m] setTitleTextColor {#console_m_settitletextcolor}

### setTitleTextColor(color) {#console_settitletextcolor_color}

**`6.3.0`**

- **color** { OmniColor (omniTypes.html#omnitypes_omnicolor) } - 浮动窗口标题文本字体颜色
- **returns** { this (console.html) }
...
## [m] setTitleBackgroundColor {#console_m_settitlebackgroundcolor}

### setTitleBackgroundColor(color) {#console_settitlebackgroundcolor_color}

**`6.3.0`**

- **color** { OmniColor (omniTypes.html#omnitypes_omnicolor) } - 浮动窗口标题显示区域背景颜色
- **returns** { this (console.html) }
...
## [m] setTitleBackgroundTint {#console_m_settitlebackgroundtint}

### setTitleBackgroundTint(color) {#console_settitlebackgroundtint_color}

**`6.6.0`**

- **color** { OmniTint (omniTypes.html#omnitypes_omnicolor) } - 浮动窗口标题显示区域背景颜色
- **returns** { this (console.html) }
...
## [m] setTitleBackgroundAlpha {#console_m_settitlebackgroundalpha}

### setTitleBackgroundAlpha(alpha) {#console_settitlebackgroundalpha_alpha}

**`6.3.0`**

- **alpha** { number (dataTypes.html#datatypes_number) } - 浮动窗口标题显示区域背景颜色透明度
- **returns** { this (console.html) }
...
## [m] resetTitleBackgroundAlpha {#console_m_resettitlebackgroundalpha}

### resetTitleBackgroundAlpha() {#console_resettitlebackgroundalpha}
...
## [m] setTitleIconsTint {#console_m_settitleiconstint}

### setTitleIconsTint(color) {#console_settitleiconstint_color}

**`6.3.0`**

- **color** { OmniColor (omniTypes.html#omnitypes_omnicolor) } - 浮动窗口操作按钮着色
- **returns** { this (console.html) }
...
## [m] setContentTextSize {#console_m_setcontenttextsize}

### setContentTextSize(size: number) {#console_setcontenttextsize_size_number}

**`6.3.0`**

- **param** { number (dataTypes.html#datatypes_number) } - 浮动窗口日志文本字体大小
- **returns** { this (console.html) }
...
## [m] setContentTextColor {#console_m_setcontenttextcolor}

### setContentTextColor(colorMap) {#console_setcontenttextcolor_colormap}

**`6.3.0`** **`Overload 1/2`**

- **colorMap** {{
- verbose?: OmniColor (omniTypes.html#omnitypes_omnicolor);
- log?: OmniColor (omniTypes.html#omnitypes_omnicolor);
- info?: OmniColor (omniTypes.html#omnitypes_omnicolor);
- warn?: OmniColor (omniTypes.html#omnitypes_omnicolor);
- error?: OmniColor (omniTypes.html#omnitypes_omnicolor);
- assert?: OmniColor (omniTypes.html#omnitypes_omnicolor);
...
### setContentTextColor(color) {#console_setcontenttextcolor_color}

**`6.3.0`** **`Overload 2/2`**

- **colors** { OmniColor (omniTypes.html#omnitypes_omnicolor) } - 浮动窗口日志文本字体统一颜色
- **returns** { this (console.html) }
...
## [m] setContentBackgroundColor {#console_m_setcontentbackgroundcolor}

### setContentBackgroundColor(color) {#console_setcontentbackgroundcolor_color}

**`6.3.0`**

- **color** { OmniColor (omniTypes.html#omnitypes_omnicolor) } - 浮动窗口日志显示区域背景颜色
- **returns** { this (console.html) }
...
## [m] setContentBackgroundAlpha {#console_m_setcontentbackgroundalpha}

### setContentBackgroundAlpha(alpha) {#console_setcontentbackgroundalpha_alpha}

**`6.3.0`**

- **alpha** { number (dataTypes.html#datatypes_number) } - 浮动窗口日志显示区域背景颜色透明度
- **returns** { this (console.html) }
...
## [m] resetContentBackgroundAlpha {#console_m_resetcontentbackgroundalpha}

### resetContentBackgroundAlpha() {#console_resetcontentbackgroundalpha}
...
## [m] setTextSize {#console_m_settextsize}

### setTextSize(size) {#console_settextsize_size}

**`6.3.0`**

- **size** { number (dataTypes.html#datatypes_number) } - 浮动窗口标题及日志文本字体大小
- **returns** { this (console.html) }
...
## [m] setTextColor {#console_m_settextcolor}

### setTextColor(color) {#console_settextcolor_color}

**`6.3.0`**

- **color** OmniColor (omniTypes.html#omnitypes_omnicolor) } - 浮动窗口标题及日志文本字体颜色
- **returns** { this (console.html) }
...
## [m] setBackgroundColor {#console_m_setbackgroundcolor}

### setBackgroundColor(color) {#console_setbackgroundcolor_color}

**`6.3.0`**

- **color** { OmniColor (omniTypes.html#omnitypes_omnicolor) } - 浮动窗口标题及日志显示区域背景颜色
- **returns** { this (console.html) }
...
## [m] setBackgroundAlpha {#console_m_setbackgroundalpha}

### setBackgroundAlpha(alpha) {#console_setbackgroundalpha_alpha}

**`6.3.0`**

- **alpha** { number (dataTypes.html#datatypes_number) } - 浮动窗口标题及日志显示区域背景颜色透明度
- **returns** { this (console.html) }
...
## [m] resetBackgroundAlpha {#console_m_resetbackgroundalpha}

### resetBackgroundAlpha() {#console_resetbackgroundalpha}
...
## [m] verbose {#console_m_verbose}

### verbose(data, ...args) {#console_verbose_data_args}

**`Global`**

- **data** { string (dataTypes.html#datatypes_string) } - 可包含占位符的待格式化对象
- **args** { ... (documentation.html#documentation_可变参数)any (dataTypes.html#datatypes_any)[] (documentation.html#documentation_可变参数) } - 占位符替换参数 (glossaries.html#glossaries_占位符替换参数)
- **returns** { void (dataTypes.html#datatypes_void) }
...
### log(data, ...args) {#console_log_data_args}
...
## [m] info {#console_m_info}

### info(data, ...args) {#console_info_data_args}
...
## [m] warn {#console_m_warn}

### warn(data, ...args) {#console_warn_data_args}
...
## [m] error {#console_m_error}

### error(data, ...args) {#console_error_data_args}
...
## [m] assert {#console_m_assert}

### assert(bool, message?) {#console_assert_bool_message}

**`6.3.0`** **`Overload [1-2]/4`**

- **bool** { boolean (dataTypes.html#datatypes_boolean) } - 断言值
- **[ message ]** { string (dataTypes.html#datatypes_string) } - 断言失败时的消息
- **returns** { void (dataTypes.html#datatypes_void) }
...
### assert(func, message?) {#console_assert_func_message}

**`6.3.0`** **`Overload [3-4]/4`**

- **func** { () => boolean (dataTypes.html#datatypes_boolean) } - 断言值
- **[ message ]** { string (dataTypes.html#datatypes_string) } - 断言失败时的消息
- **returns** { void (dataTypes.html#datatypes_void) }
...
## [m] print {#console_m_print}

### print(data, ...args) {#console_print_data_args}
...
## [m] printAllStackTrace {#console_m_printallstacktrace}

### printAllStackTrace(e) {#console_printallstacktrace_e}
...
## [m] trace {#console_m_trace}

### trace(message, level?) {#console_trace_message_level}

**`6.3.0`**

- **message** { string (dataTypes.html#datatypes_string) } - 追踪消息
- **[ level = "debug" ]** { `'verbose'` | `'debug'` | `'info'` | `'warn'` | `'error'` | number (dataTypes.html#datatypes_number) } - 消息输出等级
- **returns** { void (dataTypes.html#datatypes_void) }
...
字符串 整形常量 简述 'verbose' Log.VERBOSE = 2 对应 console.verbose 输出等级. **'debug'** Log.DEBUG = 3 对应 console.log 输出等级. 'info' Log.INFO = 4 对应 console.info 输出等级. 'warn' Log.WARN = 5 对应 console.warn 输出等级. 'error' Log.ERROR = 6 对应 console.error 输出等级.
...
## [m] time {#console_m_time}

### time(label?) {#console_time_label}

- **[ label ]** { string (dataTypes.html#datatypes_string) } - 计时标签
- **returns** { void (dataTypes.html#datatypes_void) }

启动计时器, 用以计算以 `label` 参数标记的时间间隔.

console.timeEnd 传入与 `label` 参数相同的值时, 计时器停止, 并输出时间间隔信息到控制台.
...
## [m] timeEnd {#console_m_timeend}

### timeEnd(label?) {#console_timeend_label}
...
## [m] setGlobalLogConfig {#console_m_setgloballogconfig}

### setGlobalLogConfig(config) {#console_setgloballogconfig_config}

- **config** {{
- [ file = `'android-log4j.log'` ]?: string (dataTypes.html#datatypes_string) - 待写入日志的文件路径, 支持绝对路径及相对路径
- [ maxFileSize = `512 * 1024` ]?: number (dataTypes.html#datatypes_number) - 文件的分卷阈值容量 (单位为字节)
- [ maxBackupSize = `5` ]?: number (dataTypes.html#datatypes_number) - 文件最大备份数量, 达到上限后将替换最旧文件
- [ rootLevel = `'all'` ]?: `'all'` | `'off'` | `'debug'` | `'info'` | `'warn'` | `'error'` | `'fatal'` - 日志写入级别
- [ filePattern = `'%d - [%p::%c::%C] - %m%n'` ]?: string (dataTypes.html#datatypes_string) - 日志写入格式, 参阅 PatternLayout (https://logging.apache.org/log4j/1.2/apidocs/org/apache/log4j/PatternLayout.html)
...
## [m] resetGlobalLogConfig {#console_m_resetgloballogconfig}

### resetGlobalLogConfig() {#console_resetgloballogconfig}
...
## [m] input {#console_m_input}

### input(data, ...args) {#console_input_data_args}
...
## [m] rawInput {#console_m_rawinput}

### rawInput(data, ...args) {#console_rawinput_data_args}
